...
const englishContent = {
  ...
  '.gallery .eyebrow': 'Real photos', '.gallery h2': 'Experience your stay', '.gallery .text-link': 'See more on Instagram →', '.location-copy .eyebrow': 'How to get here', '.location-copy > p': 'Panguipulli, Los Ríos Region, Chile. Find us on Google Maps and message us before travelling for directions and arrival tips.', '.location-copy .text-link': 'Open in Google Maps →',
